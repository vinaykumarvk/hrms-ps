...
V=docs/spec/ph-51-verdict.md
echo "== PH-51B exit-criteria (tranche-38 verdict; human gate) =="
...
echo "== $([ "$fail" -eq 0 ] && echo 'GREEN - PH-51B met (await HUMAN gate review)' || echo 'RED - PH-51B not complete') =="; exit "$fail"
