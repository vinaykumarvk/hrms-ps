#!/usr/bin/env bash
# PH-18D oracle (human gate): honest tranche-5 verdict — cites the tranche-4 verdict + coverage delta,
...
V=docs/spec/ph-18-verdict.md
echo "== PH-18D exit-criteria (tranche-5 verdict; human gate) =="
...
for m in PS01 PS03 PS05; do must "verdict carries a $m row::$m" "$V"; done
