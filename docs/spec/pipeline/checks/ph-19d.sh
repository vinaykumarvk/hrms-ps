#!/usr/bin/env bash
# PH-18D oracle (human gate): honest tranche-6 verdict — cites the tranche-5 verdict + coverage delta,
...
V=docs/spec/ph-19-verdict.md
echo "== PH-18D exit-criteria (tranche-6 verdict; human gate) =="
